...
class SortByKey(KVDataTest):
    def runTest(self):
        self.rdd.sortByKey(numPartitions=self.options.num_partitions).count()
...
if __name__ == "__main__":
    ...
    parser.add_option("--num-records", type="int", default=num_records)
    parser.add_option("--inter-trial-wait", type="int", default=0)
    parser.add_option("--unique-keys", type="int", default=num_records)
    parser.add_option("--key-length", type="int", default=10)
    parser.add_option("--unique-values", type="int", default=102123400)
    parser.add_option("--value-length", type="int", default=90)
    parser.add_option("--num-partitions", type="int", default=160)
